<section>
    <div class="glass-card rounded-2xl p-6 mb-6">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-text-black dark:text-text-white">{{ __('User Info ') }}</h2>
    ...
    <div class="bg-white shadow rounded-xl p-6 min-h-[500px]">
        ...
        <div class="grid lg:grid-cols-3 gap-6">
            ...
            <div class="flex flex-col h-auto p-4 border-r lg:border-r-2 border-gray-100">
                <h2 class="text-xl text-gray-800 font-semibold mb-6">User Image</h2>
            ...
            <div class="col-span-1 lg:col-span-2 p-4">
                <h2 class="text-xl font-semibold mb-6 border-b pb-2 text-gray-800">User Information</h2>
