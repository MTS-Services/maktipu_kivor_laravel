        ...
        <form wire:submit="save">
            ...
            <div class="mt-6 space-y-4 grid grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <x-ui.input id="display_name" type="text" class="mt-1 block w-full"
                ...
                <div>
                    ...
                    <x-ui.input id="date_of_birth" type="date" class="mt-1 block w-full"
                ...
                <div>
                    ...
                    <x-ui.input id="password_confirmation" type="password" class="mt-1 block w-full"
